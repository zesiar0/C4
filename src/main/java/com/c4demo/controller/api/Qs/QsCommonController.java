...
public class QsCommonController {

    @RequestMapping(value = "QS/common", method = RequestMethod.GET)

    public String get_data() throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException {

        RestTemplate restTemplate = new RestTemplate(RestTemplateConfig.generateHttpRequestFactory());

        String url = "https://117.78.31.209:26335/rest/campuswlanqualityservice/v1/expmonitor/common/basic";
        ...
        param.put("metricType", "accessSuccessRate");
        param.put("settingRefresh", false);
