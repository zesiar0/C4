...
public class campusQsController {

    @RequestMapping(value = "QS/qsdata", method = RequestMethod.GET)

    public String get_qsdata() throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException {

        RestTemplate restTemplate = new RestTemplate(RestTemplateConfig.generateHttpRequestFactory());

        String url = "https://117.78.31.209:26335/rest/campuswlanqualityservice/v1/expmonitor/overview/rate";
...
//        map.put("startTime","1624549463000");
//        map.put("endTime","1624635863000");
//        map.put("id","857b706e-67d9-49c0-b3cd-4bd1e6963c07");
